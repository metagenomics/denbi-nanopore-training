...
Put together::
  ...
  nanopolish variants --threads 14 --consensus -o ~/workdir/polishedContig.vcf -b ~/workdir/Mapping_1D_basecall_to_assembly/mapping.sorted.bam -r ~/workdir/Results/1D_basecall.fastq -g ~/workdir/canu_assembly/largestContig.fasta
