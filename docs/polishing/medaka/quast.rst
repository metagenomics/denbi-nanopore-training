...
As usual, we are going to use quast for assembly evaluation::
  ...
  cd ~/workdir
  quast.py -t 14 -o ~/workdir/quast_medaka -R ~/workdir/data/Reference.fna ~/workdir/assembly/assembly.contigs.fasta ~/workdir/racon/racon.fasta ~/workdir/racon_medaka/consensus.fasta
